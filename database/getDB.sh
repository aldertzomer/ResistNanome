...
echo "Downloading databases from https://klif.uu.nl/download/metagenomics_db/"
echo "Please be patient. This will take some time (but only once)"
echo
echo "Downloading Kraken2 db"
wget https://klif.uu.nl/download/metagenomics_db/Kraken2_Nanodb.tar.gz
echo "Downloading host filter db (Mash db)"
wget https://klif.uu.nl/download/metagenomics_db/mash_db.tar.gz
echo "Downloading KMA db"
wget https://klif.uu.nl/download/metagenomics_db/KMA_ResFinder.tar.gz
